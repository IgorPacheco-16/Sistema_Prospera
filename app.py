...
BUILD_ONLY_ALIASES = [
    ...
    ("/tarefas/<int:id>/espera/solicitar", "solicitar_espera_tarefa"),
    ("/tarefas/espera/<int:solicitacao_id>/aprovar", "aprovar_espera_tarefa"),
    ("/tarefas/espera/<int:solicitacao_id>/recusar", "recusar_espera_tarefa"),
    ("/tarefas/<int:id>/espera/retomar", "retomar_tarefa_em_espera"),
